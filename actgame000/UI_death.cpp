...
#define RESULT_SCORE_POS_X		(700.0f)							//リザルトの死亡UIのXの位置
#define RESULT_SCORE_POS_Y		(SCREEN_HEIGHT * 0.5f)				//リザルトの死亡UIのYの位置
#define SCORE_WIDTH		(50.0f * 0.5f)		//死亡UIの横幅
#define SCORE_HEIGHT	(80.0f * 0.5f)		//死亡UIの縦幅
#define SCORE_INTER		(50.0f)				//死亡UIの間隔
...
HRESULT CDeathUI::Init(void)
{
	...
	//テクスチャの読み込み
	m_nIdxTex[TEX_DEATH] = pTexture->Regist("data\\TEXTURE\\item000.png");		//死亡
