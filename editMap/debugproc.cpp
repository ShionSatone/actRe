...
void CDebugProc::Update(void)
{
	...
	CDebugProc::Print("[F4]：エリア切り替え\n");
	CDebugProc::Print("[F5]：実行\n\n");
	CDebugProc::Print("[W,A,S,D]：移動\n");
	CDebugProc::Print("[Q,E]：視点回転\n");
	CDebugProc::Print("[Z,C]：注視点回転\n");
	CDebugProc::Print("[T,B]：視点上下\n");
	CDebugProc::Print("[Y,N]：注視点上下\n");

	//モデルの操作方法
	CDebugProc::Print("\n  ～モデル操作～\n");
	//CDebugProc::Print("[F2]：リセット\n");
	CDebugProc::Print("[9]：モデルの高さリセット\n");
	CDebugProc::Print("[0]：モデルの奥行リセット\n");
	CDebugProc::Print("[1,2]：モデル種類切り替え\n");
	CDebugProc::Print("[←,↑,↓,→]：移動\n");
	CDebugProc::Print("[U,N]：上下移動\n");
	CDebugProc::Print("[ENTER]：配置\n");
	CDebugProc::Print("[F9]：保存\n");
	CDebugProc::Print("[DELETE]：モデル削除\n");
